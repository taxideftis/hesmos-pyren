...
use hesmos_core::{ContractJudgment, HandoffContract};
...
///
/// [`ContractJudgment`] itself lives in core (shared with the orchestrator's router via
/// the D-2 seam); this module owns only the judging logic.
pub fn validate(
